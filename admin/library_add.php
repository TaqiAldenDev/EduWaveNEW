...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">
                                                    <?php
                                                    echo isset($last_upload['uploaded_at']) ? date('M j', strtotime($last_upload['uploaded_at'])) : 'N/A';
                                                    ?>
                                                </h6>
                                            </div>
                                        </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="libraryBooksTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Title</th>
    ...
    <script>
        function exportTable(type) {
            const fileName = 'library_books_' + new Date().toISOString().slice(0, 10);
