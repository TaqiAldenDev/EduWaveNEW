...
<head>
    ...
    <title>Edit Class - EduWave Admin</title>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="grade_name" name="grade_name" value="<?= htmlspecialchars($class['grade_name']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="notes" class="form-label">Notes</label>
                                        <textarea class="form-control" id="notes" name="notes"><?= htmlspecialchars($class['notes']) ?></textarea>
                                    </div>
